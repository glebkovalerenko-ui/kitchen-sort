...
export default class GameScene extends Phaser.Scene {
    ...
    createGeneratorDock() {
        ...
        generatorIds.forEach((id, index) => {
            ...
            // <<< ИСПРАВЛЕНИЕ 1: Сохраняем исходную позицию X контейнера
    ...
    playTapAnimation(target, isSuccess) {
        ...
        if (isSuccess) {
            ...
            // <<< ИСПРАВЛЕНИЕ 2: Принудительно ставим контейнер на его исходное место перед анимацией
            target.parentContainer.x = startX;
            
            this.tweens.add({
                targets: target.parentContainer,
                // <<< ИСПРАВЛЕНИЕ 3: Анимируем относительно сохраненной позиции, а не текущей
                x: startX + 10,
                duration: 50,
                ease: 'Power1',
                yoyo: true,
